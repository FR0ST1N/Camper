    ...
    suite('GET /api/stock-prices => stockData object', function() {
      ...
      test('2 stocks', function(done) {
        ...
        .end(function(err, res){
          ...
          assert.equal(res.body.stockData[0].likes + res.body.stockData[1].likes, 0);
          likes = Math.abs(res.body.stockData[0].likes);
          done();
        });
      });
      ...
      test('2 stocks with like', function(done) {
        ...
        .end(function(err, res){
          ...
          assert.oneOf(res.body.stockData[1].stock, ['GOOG','AMZN']);
          assert.equal(res.body.stockData[0].likes + res.body.stockData[1].likes, 0);
          assert.equal(Math.abs(res.body.stockData[0].likes),likes);
          done();
        });
      });
